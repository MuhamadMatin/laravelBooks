<div>
    @if ($search)
        <span class="flex items-center mt-3 gap-x-2">
            <button class="text-2xl font-bold" wire:click='resetSearch()'>
    ...
    @if ($category)
        <span class="flex items-center mt-3 gap-x-2">
            <button class="text-2xl font-bold" wire:click='resetCategory()'>
                <svg class="w-4 h-4" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 460.775 460.775" xml:space="preserve">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            ...
            Category: {{ $this->books->first()->category->name ?? 'Category Unknown' }}
        </span>
    @endif
    <livewire:search />
    @include('books.bookpage', ['books' => $this->books])
    <div class="my-3">
